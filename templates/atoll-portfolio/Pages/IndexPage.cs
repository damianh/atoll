...
public sealed class IndexPage : AtollComponent, IAtollPage
{
    ...
    protected override async Task RenderCoreAsync(RenderContext context)
    {
        ...
        var heroProps = new Dictionary<string, object?>
        {
            ...
            ["Intro"] = "I build modern web applications with C# and ASP.NET Core. Passionate about clean code, performance, and developer experience.",
        };
    ...
    private static List<Dictionary<string, object?>> GetFeaturedProjects()
    {
        ...
        [
            new Dictionary<string, object?>
            {
                ...
                ["Description"] = "A description of your first featured project.",

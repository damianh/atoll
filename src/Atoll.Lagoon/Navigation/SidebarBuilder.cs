...
public sealed class SidebarBuilder
{
    ...
    /// with the locale prefix and base path for multi-locale sites.
    /// </summary>
    /// <param name="currentPath">
        ...
        string basePath)
    {
        ...
        {
            resolved.Add(ResolveItem(item, currentPath, localePrefix, basePath));
        }

        return resolved;
    }

    private ResolvedSidebarItem ResolveItem(SidebarItem item, string currentPath, string localePrefix, string basePath)
    {
        // Leaf link item
        ...
        {
            return ResolveAutoGeneratedGroup(item, currentPath, localePrefix, basePath);
        }

        // Manual group with children
        var children = ResolveItems(item.Items, currentPath, localePrefix, basePath);
    ...
    private ResolvedSidebarItem ResolveAutoGeneratedGroup(SidebarItem item, string currentPath, string localePrefix, string basePath)
    {

...
/// <summary>
/// Abstract base class for Atoll components authored as Razor templates with a strongly-typed model.
/// Extends <see cref="RazorSlice{TModel}"/> with Atoll-specific slot rendering and component embedding support.
/// </summary>
/// <typeparam name="TModel">The model type, which serves as the strongly-typed props for the component.</typeparam>
/// <remarks>
/// <para>
/// Razor template files should declare <c>@inherits AtollSlice&lt;TModel&gt;</c> to gain access to
...
/// </para>
/// </remarks>
public abstract class AtollSlice<TModel> : RazorSlice<TModel>, IAtollSliceContext
{
    /// <summary>

...
/// <summary>
/// Abstract base class for Atoll island components authored as Razor templates with a strongly-typed model.
/// Extends <see cref="AtollSlice{TModel}"/> with <see cref="IClientComponent"/> support for client-side hydration.
/// </summary>
/// <typeparam name="TModel">The model type, which serves as the strongly-typed props for the component.</typeparam>
/// <remarks>
/// <para>
/// Razor island files should declare <c>@inherits AtollIslandSlice&lt;TModel&gt;</c> and override
...
/// </para>
/// </remarks>
public abstract class AtollIslandSlice<TModel> : AtollSlice<TModel>, IClientComponent
{
    /// <inheritdoc />
